...
import Stylrax from '@/assets/images/Dlogo.svg'
import AppStore from '@/assets/images/appstorefooter.svg'
import GooglePlays from '@/assets/images/gplay.svg'
    ...
    <div className={styles.container}>
      <div className={styles.links}>
        <div className={styles.footerItem}>
          <Image src={Stylrax} alt='stylrax-logo' />

...
const FilterServices = ({ title, options, selectedOptions, onChange, formatOption }) => {
    return (
        <div className={styles.shopCategory}>
            <h5>{title}</h5>
            {options?.map((option, index) => (
                            ...
                            <div className={styles.details}>
                                <div className={styles.titlesDetails}>
                                    ...
                                    <div className={styles.wishlists}>
                                        {salon.isFavorite ? (
                                            <div className={`${styles.heart} ${salon.isFavorite ? styles.favorite : styles.nonFavorite}`}
                                                onClick={() => handleSelectFavorites(salon.id, false)}></div>
                                        ) : (
                                            <CiHeart onClick={() => handleSelectFavorites(salon.id, true)} />
                                        )}
                                        <p>wishList</p>
                                    </div>
                                </div>
